...
public class TorchIKController : MonoBehaviour, IIKAnimation
{
    ...
    {
        DayNightChangeComponent.NightSet.AddListener(OnNightStart);
        DayNightChangeComponent.DaySet.AddListener(OnDayStart);
        if (DayNightChangeComponent._isDay)
        {
            OnDayStart();
        }
        else
    ...
    {
        DayNightChangeComponent.NightSet.RemoveListener(OnNightStart);
        DayNightChangeComponent.DaySet.RemoveListener(OnDayStart);
    }
